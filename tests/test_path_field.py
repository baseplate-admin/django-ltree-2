...
class TestPathField:
    ...
    def test_path_field_validation(self, path, valid):
        """Validating that the path field is valid."""
        taxonomy = Taxonomy()
        taxonomy.name = "test"  # ty: ignore[invalid-assignment]
        ...
        if valid:
            ...
            assert excinfo.value.message_dict == {
                "path": [path_label_validator.message]
            }
    ...
    def test_slash_in_path_field(self, input_path):
    ...
    def test_mixing_slash_and_dot_in_path_field(self):
